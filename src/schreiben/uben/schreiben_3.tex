...
\begin{document}
    ...
    \section{Thema: Sollten Menschen weniger soziale Medien benutzen?}
        ...
        Außerdem müssen wir entdecken, welche politische Partei uns hilft (Am ende, weil es "Welche" baut), (kein um...zu benutz wird, weil das "Helfen" konstruktion folgt "jemand Hefen zu etwas machen". Wir müssen wissen, obwohl was in die letze Phrase erklärt worden ist man kann hilfen mit um ... zu benutzen aber die Bedutung wird ein klein bischen verschiden) unsere Rechte besser zu verteideigen.
        
        Wie es bisher erklärt worden ist(Nebenstaz), brauchen wir (zweichendrin die ) die Richtige Nachrichten, um eine praktische Democratie(f) zu haben.
