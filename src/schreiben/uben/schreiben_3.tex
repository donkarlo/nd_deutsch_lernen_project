...
\begin{document}
    ...
    \section{Thema: Sollten Menschen weniger soziale Medien benutzen?}
        ...
        Wir können entweder einzige Medium(n) davon wir erwarten Richtigeste Nachrichten erwarten oder die  mehrzahlige Median davon das Publikum der Nachrechiten verglechen kann um die  präziste Nachricht zu entnehmen.
