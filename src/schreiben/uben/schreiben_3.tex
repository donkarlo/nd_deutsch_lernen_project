...
\begin{document}
    ...
    \section{Thema: Sollten Menschen weniger soziale Medien benutzen?}
        ...
        Aus den(Plural Dativ, weil es ein Dativ objekt für verbinden ist) obigen(Schwach Adjektiv) Argumente(Plural), sind die Sozialen(Schwach nominativ Adjektiv für Medien, die der Subjekt des Satzs ist) Medien sich dirket verbinden mit der Extraxtion den Rechten Nachrichten, über die Demokratie sich basiert.
