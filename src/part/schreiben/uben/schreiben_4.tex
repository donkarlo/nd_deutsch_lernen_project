...
\begin{document}
   ...
   \section{Hinweis \textnormal{(Note)}}
      ...
      Das weiter oben(obener nicht esitiert in Deutschsprache und  man muss weiter benutzen um "upper sagen in Deutsch") gesagte ist(immer be) nicht der einzige Vorteil. 
