...
\begin{document}
   ...
   \section{Hinweis \textnormal{(Note)}}
      ...
      (Der erste Vorteil(m))(subject) ist(mit sein, immer Nominativ), dass die Einkommensschwachen(kam daramad, substantivierte Adjektiv)  auch eine äquivalente Bewegungsmöglichkeit haben können, damit ich glaube, dass die Regierung(goverment)  die Reichen mehr bAdjektivesteuern(to tax) muss, damit die Menschen, die niedrigere(Komparativ) Einkommen(neutral)haben, ein effizienteres öffentliches Verkehrssystem erreichen können.
