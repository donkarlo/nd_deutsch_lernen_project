...
\begin{document}
   ...
   \section{Hinweis \textnormal{(Note)}}
      ...
      Das Zussammensein mit den täglichen(Adjectiv schwach) Menschen(ist immer Plural) in der Geselschaft(feminin Dativ Objekt) ist ein andrer(Aus ist, wir musss ein Nominativ Adjektiv benutzen) Vorteil(masculin) an den(Aus denken an die immer mit Akkusativ kommen) ich denke(denken an ist immer mit Akkustiv). Ich persönlich genieße es sehr wenn ich in städtschen veröffentlischen Verkehrmittel(plural) die Falten(plural) der Gesichter(plural) der Täglischer Menschen. 
