...
\begin{document}
    ...
    \section{Hinweis \textnormal{(Note)}}
        ...
        \begin{infobox}
            \GermanText{Schreiben Sie ungefähr \textbf{150--200 Wörter}. Versuchen Sie, Ihre Meinung klar zu begründen und die Punkte miteinander zu verbinden.}
        ...
        Ich bin personlisch mit Lineken Pratei vebunden. 
