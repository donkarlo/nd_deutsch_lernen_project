...
\EnglishText{It is called mixed because ein-words have a visible ending in some forms and not in others. When the ein-word shows no ending, the adjective takes the strong signal ending.}
\end{grammarentry}
...
\begin{grammarentry}{Adjektive auf -er, -en und -el}{adjectives ending in -er, -en and -el}
\GermanText{Bei vielen Adjektiven auf \textbf{-er} und \textbf{-en} bleibt das \textbf{e} des Stammes bei der Deklination erhalten: \textbf{sauber} $\rightarrow$ \textbf{sauberes Wasser}, \textbf{offen} $\rightarrow$ \textbf{offene Fenster}.}
\EnglishText{With many adjectives ending in \textbf{-er} and \textbf{-en}, the stem vowel \textbf{e} is retained during declension: \textbf{sauber} $\rightarrow$ \textbf{sauberes Wasser}, \textbf{offen} $\rightarrow$ \textbf{offene Fenster}.}

\GermanText{Bei vielen Adjektiven auf \textbf{-el} fällt dagegen das unbetonte \textbf{e} vor einer Deklinationsendung weg: \textbf{edel} $\rightarrow$ \textbf{edler Wein}, \textbf{dunkel} $\rightarrow$ \textbf{dunkles Zimmer}. Deshalb heißt es \textbf{edler}, nicht \textbf{edeler}.}
\EnglishText{With many adjectives ending in \textbf{-el}, the unstressed \textbf{e} is dropped before a declension ending: \textbf{edel} $\rightarrow$ \textbf{edler Wein}, \textbf{dunkel} $\rightarrow$ \textbf{dunkles Zimmer}. Therefore the correct form is \textbf{edler}, not \textbf{edeler}.}

\GermanText{Bei einigen Adjektiven auf \textbf{-er}, besonders \textbf{teuer} und \textbf{sauer}, fällt ebenfalls ein unbetontes \textbf{e} weg: \textbf{teuer} $\rightarrow$ \textbf{teures Auto}, \textbf{sauer} $\rightarrow$ \textbf{saurer Apfel}. Das gilt aber nicht für jedes Adjektiv auf \textbf{-er}; zum Beispiel bleibt das \textbf{e} in \textbf{sauber} erhalten: \textbf{sauberes Wasser}.}
\EnglishText{With some adjectives ending in \textbf{-er}, especially \textbf{teuer} and \textbf{sauer}, an unstressed \textbf{e} is also dropped: \textbf{teuer} $\rightarrow$ \textbf{teures Auto}, \textbf{sauer} $\rightarrow$ \textbf{saurer Apfel}. However, this does not apply to every adjective ending in \textbf{-er}; for example, the \textbf{e} remains in \textbf{sauber}: \textbf{sauberes Wasser}.}
\end{grammarentry}
