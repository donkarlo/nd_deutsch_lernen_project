...
n-Deklination & + -n/-en in Akk., Dat., Gen. Sg. & Student $\rightarrow$ Studenten & sehr wichtig \\
...
\begin{grammarentry}{Vier Fragen}{Four questions}
...
\GermanText{3. Ist das Wort ein \textbf{n-Deklination-Nomen}? $\rightarrow$ Akkusativ, Dativ und Genitiv Singular mit \textbf{-n/-en}.}
\EnglishText{3. Is the word an \textbf{n-declension noun}? $\rightarrow$ accusative, dative, and genitive singular with \textbf{-n/-en}.}

\GermanText{4. Ist es ein \textbf{Sonderfall} wie \textbf{Name} oder \textbf{Herz}? $\rightarrow$ eigene Formen lernen.}
\EnglishText{4. Is it a \textbf{special case} such as \textbf{Name} or \textbf{Herz}? $\rightarrow$ learn its individual forms.}
\end{grammarentry}
