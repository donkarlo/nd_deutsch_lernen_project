...
\begin{document}
    ...
    \section{Verben mit Dativ- und Akkusativobjekt}
        ...
        \subsection{Kompakte Übersicht: Nomen und Personalpronomen}
            
            \begin{grammarentry}{Wortstellung der beiden Objekte}{Übersicht aus dem Bild}
                \GermanText{Die Reihenfolge von Dativ- und Akkusativobjekt hängt davon ab, ob die Objekte als Nomen oder als unbetonte Personalpronomen stehen. Die folgende Übersicht zeigt alle vier Grundmuster mit demselben Verb.}
                \EnglishText{The order of the dative and accusative objects depends on whether the objects are nouns or unstressed personal pronouns. The following overview shows all four basic patterns with the same verb.}
            \end{grammarentry}
            
            \rowcolors{2}{RowBlueLight}{RowBlueDark}
            \begin{longtable}{|p{4.0cm}|p{5.4cm}|p{5.0cm}|}
                \hline
                \rowcolor{HeaderBlueDark}
                \TableHeader{Form der Objekte} & \TableHeader{Beispiel} & \TableHeader{Neutrale Regel} \\
                \hline
                zwei Nomen & Ich gebe \textbf{der Studentin das Buch}. & meist: Dativ vor Akkusativ \\
                \hline
                ein Personalpronomen: Dativ & Ich gebe \textbf{ihr das Buch}. & Pronomen vor Nomen \\
                \hline
                ein Personalpronomen: Akkusativ & Ich gebe \textbf{es der Studentin}. & Pronomen vor Nomen \\
                \hline
                zwei Personalpronomen & Ich gebe \textbf{es ihr}. & Akkusativ vor Dativ \\
                \hline
            \end{longtable}
            
            \begin{exbox}
                \begin{itemize}
                    \ExampleItem{Bringt der Ober dem Gast das Bier? -- Ja, er bringt es ihm.}{Does the waiter bring the guest the beer? -- Yes, he brings it to him.}
                \end{itemize}
            \end{exbox}
            
            \begin{grammarentry}{Umwandlung in Pronomen}{das Bier $\rightarrow$ es; dem Gast $\rightarrow$ ihm}
                \GermanText{Im Antwortsatz werden beide nominalen Objekte durch Personalpronomen ersetzt. Deshalb steht das Akkusativpronomen \textbf{es} vor dem Dativpronomen \textbf{ihm}.}
                \EnglishText{In the answer, both noun objects are replaced by personal pronouns. Therefore, the accusative pronoun \textbf{es} precedes the dative pronoun \textbf{ihm}.}
            \end{grammarentry}
